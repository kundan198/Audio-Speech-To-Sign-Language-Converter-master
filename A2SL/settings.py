...
# This lets us keep GEMINI_API_KEY / ELEVENLABS_API_KEY out of source.
try:
    from dotenv import load_dotenv
    load_dotenv(os.path.join(BASE_DIR, '.env'))
except ImportError:
    pass  # SDK is optional; users can also export env vars manually.

# Below code added by RanjeetKumbhar01
import nltk
NLTK_DATA_DIR = os.environ.get('NLTK_DATA', os.path.join(BASE_DIR, 'nltk_data'))
nltk.data.path.append(NLTK_DATA_DIR)
# download nltk utilities (quiet=True so the dev server console isn't spammed)
for pkg in ('punkt', 'punkt_tab', 'averaged_perceptron_tagger',
            'averaged_perceptron_tagger_eng', 'wordnet', 'omw-1.4'):
    try:
        nltk.download(pkg, quiet=True)
    except Exception:
        pass  # offline / already present — safe to ignore
...
ALLOWED_HOSTS = ['.vercel.app', 'now.sh', '127.0.0.1', 'localhost', 'audio-speech-to-sign-language-conve-kappa.vercel.app']
