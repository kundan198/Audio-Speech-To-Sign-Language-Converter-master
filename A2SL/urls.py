...
urlpatterns = [
    ...
    path('train-signs/', views.train_signs_view, name='train_signs'),
    ...
    # path('api/recognize-signs-fast/', views.recognize_signs_fast_view, name='recognize_signs_fast'),
    path('api/training-stats/', views.training_stats_view, name='training_stats'),
    path('api/save-training-sample/', views.save_training_sample_view, name='save_training_sample'),
    ...
    path('api/live-recognize/', views.live_recognize_view, name='live_recognize'),
    path('api/batch-recognize/', views.batch_recognize_view, name='batch_recognize'),
